...
const (
	...
	VChannelState_VCHANNEL_STATE_TOMBSTONED VChannelState = 3 // vchannel data has caught up and this retained meta is a replay filter.
)
...
// PartitionState is the recovery state of a partition in vchannel meta.
type PartitionState int32

const (
	PartitionState_PARTITION_STATE_UNKNOWN    PartitionState = 0 // should never used.
	PartitionState_PARTITION_STATE_NORMAL     PartitionState = 1 // partition is normal.
	PartitionState_PARTITION_STATE_DROPPED    PartitionState = 2 // partition is dropped but retained for data replay.
	PartitionState_PARTITION_STATE_TOMBSTONED PartitionState = 3 // partition data has caught up and this retained meta is a replay filter.
)

// Enum value maps for PartitionState.
var (
	PartitionState_name = map[int32]string{
		0: "PARTITION_STATE_UNKNOWN",
		1: "PARTITION_STATE_NORMAL",
		2: "PARTITION_STATE_DROPPED",
		3: "PARTITION_STATE_TOMBSTONED",
	}
	PartitionState_value = map[string]int32{
		"PARTITION_STATE_UNKNOWN":    0,
		"PARTITION_STATE_NORMAL":     1,
		"PARTITION_STATE_DROPPED":    2,
		"PARTITION_STATE_TOMBSTONED": 3,
	}
)
...
const (
	...
	SegmentAssignmentState_SEGMENT_ASSIGNMENT_STATE_TOMBSTONED SegmentAssignmentState = 3
)
...
var (
	SegmentAssignmentState_name = map[int32]string{
		...
		3: "SEGMENT_ASSIGNMENT_STATE_TOMBSTONED",
	}
	SegmentAssignmentState_value = map[string]int32{
		...
		"SEGMENT_ASSIGNMENT_STATE_TOMBSTONED": 3,
	}
)
...
type StreamingNodeAssignment struct {
	...
	Channels []*PChannelInfo    `protobuf:"bytes,2,rep,name=channels,proto3" json:"channels,omitempty"` // Primary pchannels (WAL owner, read-write). Unchanged for backward compatibility.
	// Shard-to-replica mapping for loaded collections on this SN.
	ShardAssignment *ShardAssignmentInfo `protobuf:"bytes,3,opt,name=shard_assignment,json=shardAssignment,proto3" json:"shard_assignment,omitempty"`
	// Secondary (read-only) pchannel replicas on this SN.
	// These pchannels subscribe to the WAL but do not own it.
	// Primary pchannels remain in the channels field above.
	SecondaryChannels []*PChannelInfo `protobuf:"bytes,4,rep,name=secondary_channels,json=secondaryChannels,proto3" json:"secondary_channels,omitempty"`
}
...
func (x *StreamingNodeAssignment) GetShardAssignment() *ShardAssignmentInfo {
	if x != nil {
		return x.ShardAssignment
	}
	return nil
}

func (x *StreamingNodeAssignment) GetSecondaryChannels() []*PChannelInfo {
	if x != nil {
...
// ShardAssignmentInfo carries pchannel-scoped shard-to-replica mappings for a single StreamingNode.
// Published as part of channel assignment full updates.
type ShardAssignmentInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PchannelAssignments []*PChannelShardAssignment `protobuf:"bytes,1,rep,name=pchannel_assignments,json=pchannelAssignments,proto3" json:"pchannel_assignments,omitempty"`
}
...
func (x *ShardAssignmentInfo) GetPchannelAssignments() []*PChannelShardAssignment {
	if x != nil {
		return x.PchannelAssignments
	}
	return nil
}

// PChannelShardAssignment carries shard replicas on one pchannel of a StreamingNode.
// The pchannel must appear in the same StreamingNodeAssignment's channels or secondary_channels.
type PChannelShardAssignment struct {
	...
	Entries  []*ShardAssignmentEntry `protobuf:"bytes,2,rep,name=entries,proto3" json:"entries,omitempty"`
}

func (x *PChannelShardAssignment) Reset() {
	*x = PChannelShardAssignment{}
	if protoimpl.UnsafeEnabled {
...
func (x *PChannelShardAssignment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PChannelShardAssignment) ProtoMessage() {}

func (x *PChannelShardAssignment) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PChannelShardAssignment.ProtoReflect.Descriptor instead.
func (*PChannelShardAssignment) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{29}
}

func (x *PChannelShardAssignment) GetPchannel() string {
	if x != nil {
		return x.Pchannel
	}
	return ""
...
func (x *PChannelShardAssignment) GetEntries() []*ShardAssignmentEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
// ShardAssignmentEntry identifies a single shard replica on this SN.
type ShardAssignmentEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CollectionId int64 `protobuf:"varint,1,opt,name=collection_id,json=collectionId,proto3" json:"collection_id,omitempty"` // Collection this shard belongs to.
	ShardIndex   int32 `protobuf:"varint,2,opt,name=shard_index,json=shardIndex,proto3" json:"shard_index,omitempty"`       // Shard index within the collection (0-based).
	ReplicaId    int64 `protobuf:"varint,3,opt,name=replica_id,json=replicaId,proto3" json:"replica_id,omitempty"`          // Replica this shard belongs to.
}

func (x *ShardAssignmentEntry) Reset() {
	*x = ShardAssignmentEntry{}
	if protoimpl.UnsafeEnabled {
...
func (x *ShardAssignmentEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShardAssignmentEntry) ProtoMessage() {}

func (x *ShardAssignmentEntry) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShardAssignmentEntry.ProtoReflect.Descriptor instead.
func (*ShardAssignmentEntry) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{30}
}

func (x *ShardAssignmentEntry) GetCollectionId() int64 {
	if x != nil {
...
func (x *ShardAssignmentEntry) GetShardIndex() int32 {
	if x != nil {
		return x.ShardIndex
	}
	return 0
...
func (x *ShardAssignmentEntry) GetReplicaId() int64 {
	if x != nil {
		return x.ReplicaId
	}
	return 0
...
// CreateTransformStreamRequest is passed in SubscribeTransform stream metadata.
type CreateTransformStreamRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateTransformStreamRequest) Reset() {
	*x = CreateTransformStreamRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateTransformStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateTransformStreamRequest) ProtoMessage() {}

func (x *CreateTransformStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[64]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateTransformStreamRequest.ProtoReflect.Descriptor instead.
func (*CreateTransformStreamRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{64}
}

func (x *CreateTransformStreamRequest) GetPchannel() *PChannelInfo {
	if x != nil {
		return x.Pchannel
	}
	return nil
...
// TransformRequest is the request of the SubscribeTransform RPC.
type TransformRequest struct {
	...
	// Types that are assignable to Request:
	//
	//	*TransformRequest_Create
	//	*TransformRequest_CloseSubscription
	//	*TransformRequest_CloseStream
...
func (x *TransformRequest) GetCreate() *CreateTransformSubscriptionRequest {
	if x, ok := x.GetRequest().(*TransformRequest_Create); ok {
		return x.Create
	}
	return nil
}

func (x *TransformRequest) GetCloseSubscription() *CloseTransformSubscriptionRequest {
	if x, ok := x.GetRequest().(*TransformRequest_CloseSubscription); ok {
		return x.CloseSubscription
	}
	return nil
}

func (x *TransformRequest) GetCloseStream() *CloseTransformStreamRequest {
	if x, ok := x.GetRequest().(*TransformRequest_CloseStream); ok {
...
type TransformRequest_Create struct {
	Create *CreateTransformSubscriptionRequest `protobuf:"bytes,1,opt,name=create,proto3,oneof"`
}

type TransformRequest_CloseSubscription struct {
	CloseSubscription *CloseTransformSubscriptionRequest `protobuf:"bytes,2,opt,name=close_subscription,json=closeSubscription,proto3,oneof"`
}

type TransformRequest_CloseStream struct {
	CloseStream *CloseTransformStreamRequest `protobuf:"bytes,3,opt,name=close_stream,json=closeStream,proto3,oneof"`
}

func (*TransformRequest_Create) isTransformRequest_Request() {}

func (*TransformRequest_CloseSubscription) isTransformRequest_Request() {}

func (*TransformRequest_CloseStream) isTransformRequest_Request() {}

// CreateTransformSubscriptionRequest creates a remote vchannel-level transform
// scanner on a SubscribeTransform stream.
type CreateTransformSubscriptionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Exclusive. Server sends TransformLog entries with time_tick >
	// start_after_time_tick.
	StartAfterTimeTick uint64 `protobuf:"varint,3,opt,name=start_after_time_tick,json=startAfterTimeTick,proto3" json:"start_after_time_tick,omitempty"`
	// Inclusive. When non-zero, server stops after consuming entries with
	// time_tick <= end_time_tick.
	EndTimeTick uint64 `protobuf:"varint,4,opt,name=end_time_tick,json=endTimeTick,proto3" json:"end_time_tick,omitempty"`
}

func (x *CreateTransformSubscriptionRequest) Reset() {
	*x = CreateTransformSubscriptionRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateTransformSubscriptionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateTransformSubscriptionRequest) ProtoMessage() {}

func (x *CreateTransformSubscriptionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[66]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateTransformSubscriptionRequest.ProtoReflect.Descriptor instead.
func (*CreateTransformSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{66}
}

func (x *CreateTransformSubscriptionRequest) GetSubscriptionId() int64 {
	if x != nil {
...
func (x *CreateTransformSubscriptionRequest) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *CreateTransformSubscriptionRequest) GetStartAfterTimeTick() uint64 {
	if x != nil {
		return x.StartAfterTimeTick
	}
	return 0
}

func (x *CreateTransformSubscriptionRequest) GetEndTimeTick() uint64 {
	if x != nil {
		return x.EndTimeTick
	}
	return 0
}

// CloseTransformSubscriptionRequest closes one vchannel subscription on a
// SubscribeTransform stream.
type CloseTransformSubscriptionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CloseTransformSubscriptionRequest) Reset() {
	*x = CloseTransformSubscriptionRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CloseTransformSubscriptionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloseTransformSubscriptionRequest) ProtoMessage() {}

func (x *CloseTransformSubscriptionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[67]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloseTransformSubscriptionRequest.ProtoReflect.Descriptor instead.
func (*CloseTransformSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{67}
}

func (x *CloseTransformSubscriptionRequest) GetSubscriptionId() int64 {
	if x != nil {
		return x.SubscriptionId
	}
	return 0
...
// CloseTransformStreamRequest gracefully closes the SubscribeTransform stream.
type CloseTransformStreamRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *CloseTransformStreamRequest) Reset() {
	*x = CloseTransformStreamRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CloseTransformStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloseTransformStreamRequest) ProtoMessage() {}

func (x *CloseTransformStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[68]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloseTransformStreamRequest.ProtoReflect.Descriptor instead.
func (*CloseTransformStreamRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{68}
}

// TransformResponse is the response of the SubscribeTransform RPC.
type TransformResponse struct {
	...
	// Types that are assignable to Response:
	//
	//	*TransformResponse_Create
	//	*TransformResponse_MessageBatch
	//	*TransformResponse_SyncUp
	//	*TransformResponse_SubscriptionError
	//	*TransformResponse_CloseSubscription
	//	*TransformResponse_CloseStream
	Response isTransformResponse_Response `protobuf_oneof:"response"`
}
...
func (m *TransformResponse) GetResponse() isTransformResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *TransformResponse) GetCreate() *CreateTransformSubscriptionResponse {
	if x, ok := x.GetResponse().(*TransformResponse_Create); ok {
		return x.Create
	}
	return nil
}

func (x *TransformResponse) GetMessageBatch() *TransformMessageBatch {
	if x, ok := x.GetResponse().(*TransformResponse_MessageBatch); ok {
		return x.MessageBatch
	}
	return nil
}

func (x *TransformResponse) GetSyncUp() *TransformSubscriptionSyncUp {
	if x, ok := x.GetResponse().(*TransformResponse_SyncUp); ok {
		return x.SyncUp
	}
	return nil
}

func (x *TransformResponse) GetSubscriptionError() *TransformSubscriptionError {
	if x, ok := x.GetResponse().(*TransformResponse_SubscriptionError); ok {
		return x.SubscriptionError
	}
	return nil
}

func (x *TransformResponse) GetCloseSubscription() *CloseTransformSubscriptionResponse {
	if x, ok := x.GetResponse().(*TransformResponse_CloseSubscription); ok {
		return x.CloseSubscription
	}
	return nil
}

func (x *TransformResponse) GetCloseStream() *CloseTransformStreamResponse {
	if x, ok := x.GetResponse().(*TransformResponse_CloseStream); ok {
		return x.CloseStream
	}
	return nil
}

type isTransformResponse_Response interface {
	isTransformResponse_Response()
}

type TransformResponse_Create struct {
	Create *CreateTransformSubscriptionResponse `protobuf:"bytes,1,opt,name=create,proto3,oneof"`
}

type TransformResponse_MessageBatch struct {
	MessageBatch *TransformMessageBatch `protobuf:"bytes,2,opt,name=message_batch,json=messageBatch,proto3,oneof"`
}

type TransformResponse_SyncUp struct {
	SyncUp *TransformSubscriptionSyncUp `protobuf:"bytes,3,opt,name=sync_up,json=syncUp,proto3,oneof"`
}

type TransformResponse_SubscriptionError struct {
	SubscriptionError *TransformSubscriptionError `protobuf:"bytes,4,opt,name=subscription_error,json=subscriptionError,proto3,oneof"`
}

type TransformResponse_CloseSubscription struct {
	CloseSubscription *CloseTransformSubscriptionResponse `protobuf:"bytes,5,opt,name=close_subscription,json=closeSubscription,proto3,oneof"`
}

type TransformResponse_CloseStream struct {
	CloseStream *CloseTransformStreamResponse `protobuf:"bytes,6,opt,name=close_stream,json=closeStream,proto3,oneof"`
}

func (*TransformResponse_Create) isTransformResponse_Response() {}

func (*TransformResponse_MessageBatch) isTransformResponse_Response() {}

func (*TransformResponse_SyncUp) isTransformResponse_Response() {}

func (*TransformResponse_SubscriptionError) isTransformResponse_Response() {}

func (*TransformResponse_CloseSubscription) isTransformResponse_Response() {}

func (*TransformResponse_CloseStream) isTransformResponse_Response() {}

// CreateTransformSubscriptionResponse acknowledges creation of one vchannel
// transform scanner.
type CreateTransformSubscriptionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Vchannel           string `protobuf:"bytes,2,opt,name=vchannel,proto3" json:"vchannel,omitempty"`
	StartAfterTimeTick uint64 `protobuf:"varint,3,opt,name=start_after_time_tick,json=startAfterTimeTick,proto3" json:"start_after_time_tick,omitempty"`
	EndTimeTick        uint64 `protobuf:"varint,5,opt,name=end_time_tick,json=endTimeTick,proto3" json:"end_time_tick,omitempty"`
	// Current SN TransformLog truncation cursor.
	TruncateTimeTick uint64 `protobuf:"varint,4,opt,name=truncate_time_tick,json=truncateTimeTick,proto3" json:"truncate_time_tick,omitempty"`
}

func (x *CreateTransformSubscriptionResponse) Reset() {
	*x = CreateTransformSubscriptionResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateTransformSubscriptionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateTransformSubscriptionResponse) ProtoMessage() {}

func (x *CreateTransformSubscriptionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[70]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateTransformSubscriptionResponse.ProtoReflect.Descriptor instead.
func (*CreateTransformSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{70}
}

func (x *CreateTransformSubscriptionResponse) GetSubscriptionId() int64 {
	if x != nil {
		return x.SubscriptionId
	}
	return 0
...
func (x *CreateTransformSubscriptionResponse) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *CreateTransformSubscriptionResponse) GetStartAfterTimeTick() uint64 {
	if x != nil {
		return x.StartAfterTimeTick
	}
	return 0
...
func (x *CreateTransformSubscriptionResponse) GetEndTimeTick() uint64 {
	if x != nil {
		return x.EndTimeTick
	}
	return 0
...
func (x *CreateTransformSubscriptionResponse) GetTruncateTimeTick() uint64 {
	if x != nil {
		return x.TruncateTimeTick
	}
	return 0
}

// CloseTransformSubscriptionResponse acknowledges closing one vchannel
// subscription on a SubscribeTransform stream.
type CloseTransformSubscriptionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CloseTransformSubscriptionResponse) Reset() {
	*x = CloseTransformSubscriptionResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CloseTransformSubscriptionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloseTransformSubscriptionResponse) ProtoMessage() {}

func (x *CloseTransformSubscriptionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[71]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloseTransformSubscriptionResponse.ProtoReflect.Descriptor instead.
func (*CloseTransformSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{71}
}

func (x *CloseTransformSubscriptionResponse) GetSubscriptionId() int64 {
	if x != nil {
		return x.SubscriptionId
	}
	return 0
...
func (x *CloseTransformSubscriptionResponse) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
// TransformSubscriptionSyncUp is a transform frontier event. After receiving
// SyncUp(time_tick), all TransformLog entries with time_tick <= SyncUp.time_tick
// have been delivered to this subscription.
type TransformSubscriptionSyncUp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TransformSubscriptionSyncUp) Reset() {
	*x = TransformSubscriptionSyncUp{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformSubscriptionSyncUp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformSubscriptionSyncUp) ProtoMessage() {}

func (x *TransformSubscriptionSyncUp) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[72]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformSubscriptionSyncUp.ProtoReflect.Descriptor instead.
func (*TransformSubscriptionSyncUp) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{72}
}

func (x *TransformSubscriptionSyncUp) GetSubscriptionId() int64 {
	if x != nil {
		return x.SubscriptionId
	}
	return 0
...
func (x *TransformSubscriptionSyncUp) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *TransformSubscriptionSyncUp) GetTimeTick() uint64 {
	if x != nil {
		return x.TimeTick
	}
	return 0
...
// TransformSubscriptionError carries a StreamingError for one subscription on a
// multiplexed SubscribeTransform stream.
type TransformSubscriptionError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SubscriptionId int64           `protobuf:"varint,1,opt,name=subscription_id,json=subscriptionId,proto3" json:"subscription_id,omitempty"`
	Vchannel       string          `protobuf:"bytes,2,opt,name=vchannel,proto3" json:"vchannel,omitempty"`
	Error          *StreamingError `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`
}

func (x *TransformSubscriptionError) Reset() {
	*x = TransformSubscriptionError{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformSubscriptionError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformSubscriptionError) ProtoMessage() {}

func (x *TransformSubscriptionError) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[73]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformSubscriptionError.ProtoReflect.Descriptor instead.
func (*TransformSubscriptionError) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{73}
}

func (x *TransformSubscriptionError) GetSubscriptionId() int64 {
	if x != nil {
		return x.SubscriptionId
	}
	return 0
...
func (x *TransformSubscriptionError) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *TransformSubscriptionError) GetError() *StreamingError {
	if x != nil {
		return x.Error
	}
	return nil
...
// CloseTransformStreamResponse acknowledges graceful stream close.
type CloseTransformStreamResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *CloseTransformStreamResponse) Reset() {
	*x = CloseTransformStreamResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CloseTransformStreamResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloseTransformStreamResponse) ProtoMessage() {}

func (x *CloseTransformStreamResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[74]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloseTransformStreamResponse.ProtoReflect.Descriptor instead.
func (*CloseTransformStreamResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{74}
}

// TransformMessageBatch is an at-least-once delivery unit for transform
// entries.
type TransformMessageBatch struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SubscriptionId int64  `protobuf:"varint,1,opt,name=subscription_id,json=subscriptionId,proto3" json:"subscription_id,omitempty"`
	Vchannel       string `protobuf:"bytes,2,opt,name=vchannel,proto3" json:"vchannel,omitempty"`
	// Entries are ordered by TransformLogEntry.time_tick.
	Entries []*TransformLogEntry `protobuf:"bytes,3,rep,name=entries,proto3" json:"entries,omitempty"`
}

func (x *TransformMessageBatch) Reset() {
	*x = TransformMessageBatch{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformMessageBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformMessageBatch) ProtoMessage() {}

func (x *TransformMessageBatch) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[75]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformMessageBatch.ProtoReflect.Descriptor instead.
func (*TransformMessageBatch) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{75}
}

func (x *TransformMessageBatch) GetSubscriptionId() int64 {
	if x != nil {
		return x.SubscriptionId
	}
	return 0
...
func (x *TransformMessageBatch) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *TransformMessageBatch) GetEntries() []*TransformLogEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
type TransformDeleteBlock struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PartitionId int64         `protobuf:"varint,1,opt,name=partition_id,json=partitionId,proto3" json:"partition_id,omitempty"`
	PrimaryKeys *schemapb.IDs `protobuf:"bytes,2,opt,name=primary_keys,json=primaryKeys,proto3" json:"primary_keys,omitempty"`
}

func (x *TransformDeleteBlock) Reset() {
	*x = TransformDeleteBlock{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformDeleteBlock) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformDeleteBlock) ProtoMessage() {}

func (x *TransformDeleteBlock) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[76]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformDeleteBlock.ProtoReflect.Descriptor instead.
func (*TransformDeleteBlock) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{76}
}

func (x *TransformDeleteBlock) GetPartitionId() int64 {
	if x != nil {
...
func (x *TransformDeleteBlock) GetPrimaryKeys() *schemapb.IDs {
	if x != nil {
...
type TransformDeleteEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Blocks []*TransformDeleteBlock `protobuf:"bytes,1,rep,name=blocks,proto3" json:"blocks,omitempty"`
}

func (x *TransformDeleteEntry) Reset() {
	*x = TransformDeleteEntry{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformDeleteEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformDeleteEntry) ProtoMessage() {}

func (x *TransformDeleteEntry) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[77]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformDeleteEntry.ProtoReflect.Descriptor instead.
func (*TransformDeleteEntry) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{77}
}

func (x *TransformDeleteEntry) GetBlocks() []*TransformDeleteBlock {
	if x != nil {
		return x.Blocks
	}
	return nil
...
// TransformLogEntry is the durable and subscription replay unit.
type TransformLogEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Source WAL message TimeTick, also the MVCC TimeTick.
	TimeTick uint64 `protobuf:"varint,1,opt,name=time_tick,json=timeTick,proto3" json:"time_tick,omitempty"`
	// Types that are assignable to Entry:
	//
	//	*TransformLogEntry_Delete
	Entry isTransformLogEntry_Entry `protobuf_oneof:"entry"`
}

func (x *TransformLogEntry) Reset() {
	*x = TransformLogEntry{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformLogEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformLogEntry) ProtoMessage() {}

func (x *TransformLogEntry) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[78]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformLogEntry.ProtoReflect.Descriptor instead.
func (*TransformLogEntry) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{78}
}

func (x *TransformLogEntry) GetTimeTick() uint64 {
	if x != nil {
		return x.TimeTick
	}
	return 0
...
func (m *TransformLogEntry) GetEntry() isTransformLogEntry_Entry {
	if m != nil {
		return m.Entry
	}
	return nil
...
func (x *TransformLogEntry) GetDelete() *TransformDeleteEntry {
	if x, ok := x.GetEntry().(*TransformLogEntry_Delete); ok {
		return x.Delete
	}
	return nil
}

type isTransformLogEntry_Entry interface {
	isTransformLogEntry_Entry()
}

type TransformLogEntry_Delete struct {
	Delete *TransformDeleteEntry `protobuf:"bytes,2,opt,name=delete,proto3,oneof"`
}

func (*TransformLogEntry_Delete) isTransformLogEntry_Entry() {}
...
type TransformLogChunk struct {
	...
	Entries []*TransformLogEntry `protobuf:"bytes,2,rep,name=entries,proto3" json:"entries,omitempty"`
}

func (x *TransformLogChunk) Reset() {
	*x = TransformLogChunk{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformLogChunk) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformLogChunk) ProtoMessage() {}

func (x *TransformLogChunk) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[79]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformLogChunk.ProtoReflect.Descriptor instead.
func (*TransformLogChunk) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{79}
}

func (x *TransformLogChunk) GetChunkId() uint64 {
	if x != nil {
		return x.ChunkId
	}
	return 0
...
func (x *TransformLogChunk) GetEntries() []*TransformLogEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
type VChannelTransformLogMeta struct {
	...
	CheckpointTimeTick uint64 `protobuf:"varint,1,opt,name=checkpoint_time_tick,json=checkpointTimeTick,proto3" json:"checkpoint_time_tick,omitempty"`
	// Entries with time_tick <= truncate_time_tick may be removed.
	TruncateTimeTick uint64 `protobuf:"varint,2,opt,name=truncate_time_tick,json=truncateTimeTick,proto3" json:"truncate_time_tick,omitempty"`
	// Retained dense chunk id range: [first_chunk_id, next_chunk_id).
	FirstChunkId uint64 `protobuf:"varint,3,opt,name=first_chunk_id,json=firstChunkId,proto3" json:"first_chunk_id,omitempty"`
	NextChunkId  uint64 `protobuf:"varint,4,opt,name=next_chunk_id,json=nextChunkId,proto3" json:"next_chunk_id,omitempty"`
	// L0 materializer cursor.
	MaterializedTimeTick uint64 `protobuf:"varint,5,opt,name=materialized_time_tick,json=materializedTimeTick,proto3" json:"materialized_time_tick,omitempty"`
}

func (x *VChannelTransformLogMeta) Reset() {
	*x = VChannelTransformLogMeta{}
	if protoimpl.UnsafeEnabled {
...
func (x *VChannelTransformLogMeta) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VChannelTransformLogMeta) ProtoMessage() {}

func (x *VChannelTransformLogMeta) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[80]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VChannelTransformLogMeta.ProtoReflect.Descriptor instead.
func (*VChannelTransformLogMeta) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{80}
}

func (x *VChannelTransformLogMeta) GetCheckpointTimeTick() uint64 {
	if x != nil {
...
func (x *VChannelTransformLogMeta) GetTruncateTimeTick() uint64 {
	if x != nil {
		return x.TruncateTimeTick
	}
	return 0
...
func (x *VChannelTransformLogMeta) GetFirstChunkId() uint64 {
	if x != nil {
...
func (x *VChannelTransformLogMeta) GetNextChunkId() uint64 {
	if x != nil {
...
func (x *VChannelTransformLogMeta) GetMaterializedTimeTick() uint64 {
	if x != nil {
		return x.MaterializedTimeTick
	}
	return 0
}
...
func (x *StreamingNodeMetrics) Reset() {
	*x = StreamingNodeMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[86]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamingNodeMetrics) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{86}
}
...
func (x *StreamingNodeWALMetrics) Reset() {
	*x = StreamingNodeWALMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[87]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamingNodeWALMetrics) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{87}
}
...
func (x *StreamingNodeRWWALMetrics) Reset() {
	*x = StreamingNodeRWWALMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[88]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamingNodeRWWALMetrics) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{88}
}
...
func (x *StreamingNodeROWALMetrics) Reset() {
	*x = StreamingNodeROWALMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[89]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamingNodeROWALMetrics) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{89}
}
...
func (x *StreamingNodeManagerCollectStatusResponse) Reset() {
	*x = StreamingNodeManagerCollectStatusResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[90]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamingNodeManagerCollectStatusResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{90}
}
...
type StreamingNodeRuntimeAnalyzerInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamingNodeRuntimeAnalyzerInfo) Reset() {
	*x = StreamingNodeRuntimeAnalyzerInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[91]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StreamingNodeRuntimeAnalyzerInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingNodeRuntimeAnalyzerInfo) ProtoMessage() {}

func (x *StreamingNodeRuntimeAnalyzerInfo) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[91]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingNodeRuntimeAnalyzerInfo.ProtoReflect.Descriptor instead.
func (*StreamingNodeRuntimeAnalyzerInfo) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{91}
}

func (x *StreamingNodeRuntimeAnalyzerInfo) GetParams() string {
	if x != nil {
		return x.Params
	}
	return ""
...
func (x *StreamingNodeRuntimeAnalyzerInfo) GetField() string {
	if x != nil {
		return x.Field
	}
	return ""
...
func (x *StreamingNodeRuntimeAnalyzerInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type StreamingNodeRuntimeAnalyzerValidation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AnalyzerInfos []*StreamingNodeRuntimeAnalyzerInfo `protobuf:"bytes,1,rep,name=analyzer_infos,json=analyzerInfos,proto3" json:"analyzer_infos,omitempty"`
}

func (x *StreamingNodeRuntimeAnalyzerValidation) Reset() {
	*x = StreamingNodeRuntimeAnalyzerValidation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[92]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StreamingNodeRuntimeAnalyzerValidation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingNodeRuntimeAnalyzerValidation) ProtoMessage() {}

func (x *StreamingNodeRuntimeAnalyzerValidation) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[92]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingNodeRuntimeAnalyzerValidation.ProtoReflect.Descriptor instead.
func (*StreamingNodeRuntimeAnalyzerValidation) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{92}
}

func (x *StreamingNodeRuntimeAnalyzerValidation) GetAnalyzerInfos() []*StreamingNodeRuntimeAnalyzerInfo {
	if x != nil {
...
type StreamingNodeManagerValidateRuntimeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*StreamingNodeManagerValidateRuntimeRequest_Analyzer
	Validation isStreamingNodeManagerValidateRuntimeRequest_Validation `protobuf_oneof:"validation"`
}

func (x *StreamingNodeManagerValidateRuntimeRequest) Reset() {
	*x = StreamingNodeManagerValidateRuntimeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[93]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StreamingNodeManagerValidateRuntimeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingNodeManagerValidateRuntimeRequest) ProtoMessage() {}

func (x *StreamingNodeManagerValidateRuntimeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[93]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingNodeManagerValidateRuntimeRequest.ProtoReflect.Descriptor instead.
func (*StreamingNodeManagerValidateRuntimeRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{93}
}

func (m *StreamingNodeManagerValidateRuntimeRequest) GetValidation() isStreamingNodeManagerValidateRuntimeRequest_Validation {
	if m != nil {
		return m.Validation
	}
	return nil
...
func (x *StreamingNodeManagerValidateRuntimeRequest) GetAnalyzer() *StreamingNodeRuntimeAnalyzerValidation {
	if x, ok := x.GetValidation().(*StreamingNodeManagerValidateRuntimeRequest_Analyzer); ok {
		return x.Analyzer
	}
	return nil
}

type isStreamingNodeManagerValidateRuntimeRequest_Validation interface {
	isStreamingNodeManagerValidateRuntimeRequest_Validation()
}

type StreamingNodeManagerValidateRuntimeRequest_Analyzer struct {
	Analyzer *StreamingNodeRuntimeAnalyzerValidation `protobuf:"bytes,1,opt,name=analyzer,proto3,oneof"`
}

func (*StreamingNodeManagerValidateRuntimeRequest_Analyzer) isStreamingNodeManagerValidateRuntimeRequest_Validation() {
}

type StreamingNodeManagerValidateRuntimeResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamingNodeManagerValidateRuntimeResponse) Reset() {
	*x = StreamingNodeManagerValidateRuntimeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[94]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StreamingNodeManagerValidateRuntimeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingNodeManagerValidateRuntimeResponse) ProtoMessage() {}

func (x *StreamingNodeManagerValidateRuntimeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[94]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingNodeManagerValidateRuntimeResponse.ProtoReflect.Descriptor instead.
func (*StreamingNodeManagerValidateRuntimeResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{94}
}

func (x *StreamingNodeManagerValidateRuntimeResponse) GetStatus() *commonpb.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *StreamingNodeManagerValidateRuntimeResponse) GetResourceIds() []int64 {
	if x != nil {
...
type VChannelMeta struct {
	...
	TombstoneTimeTick  uint64                    `protobuf:"varint,6,opt,name=tombstone_time_tick,json=tombstoneTimeTick,proto3" json:"tombstone_time_tick,omitempty"`    // The timetick this retained vchannel meta starts filtering replay.
}

func (x *VChannelMeta) Reset() {
	*x = VChannelMeta{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[95]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VChannelMeta) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{95}
}
...
func (x *VChannelMeta) GetTombstoneTimeTick() uint64 {
	if x != nil {
...
type SegmentDataVersionSummary struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DataVersion *viewpb.DataVersion `protobuf:"bytes,1,opt,name=data_version,json=dataVersion,proto3" json:"data_version,omitempty"`
}

func (x *SegmentDataVersionSummary) Reset() {
	*x = SegmentDataVersionSummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[96]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SegmentDataVersionSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SegmentDataVersionSummary) ProtoMessage() {}

func (x *SegmentDataVersionSummary) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[96]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SegmentDataVersionSummary.ProtoReflect.Descriptor instead.
func (*SegmentDataVersionSummary) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{96}
}

func (x *SegmentDataVersionSummary) GetDataVersion() *viewpb.DataVersion {
	if x != nil {
...
func (x *CollectionInfoOfVChannel) Reset() {
	*x = CollectionInfoOfVChannel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[97]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CollectionInfoOfVChannel) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{97}
}
...
func (x *CollectionSchemaOfVChannel) Reset() {
	*x = CollectionSchemaOfVChannel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[98]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CollectionSchemaOfVChannel) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{98}
}
...
type PartitionInfoOfVChannel struct {
	...
	State             PartitionState `protobuf:"varint,2,opt,name=state,proto3,enum=milvus.proto.streaming.PartitionState" json:"state,omitempty"`         // partition recovery state.
	TombstoneTimeTick uint64         `protobuf:"varint,3,opt,name=tombstone_time_tick,json=tombstoneTimeTick,proto3" json:"tombstone_time_tick,omitempty"` // The timetick this retained partition meta starts filtering replay.
}

func (x *PartitionInfoOfVChannel) Reset() {
	*x = PartitionInfoOfVChannel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[99]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PartitionInfoOfVChannel) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{99}
}
...
func (x *PartitionInfoOfVChannel) GetState() PartitionState {
	if x != nil {
		return x.State
	}
	return PartitionState_PARTITION_STATE_UNKNOWN
}

func (x *PartitionInfoOfVChannel) GetTombstoneTimeTick() uint64 {
	if x != nil {
		return x.TombstoneTimeTick
	}
	return 0
...
type SegmentAssignmentMeta struct {
	...
	PersistedStorage       *L1SegmentPersistedStorage `protobuf:"bytes,9,opt,name=persisted_storage,json=persistedStorage,proto3" json:"persisted_storage,omitempty"`
	SealedAtDataVersion    *viewpb.DataVersion        `protobuf:"bytes,10,opt,name=sealed_at_data_version,json=sealedAtDataVersion,proto3" json:"sealed_at_data_version,omitempty"`
	DataCheckpointTimeTick uint64                     `protobuf:"varint,11,opt,name=data_checkpoint_time_tick,json=dataCheckpointTimeTick,proto3" json:"data_checkpoint_time_tick,omitempty"` // The timetick of data checkpoint, the segment data already durable at this timetick.
	TombstoneTimeTick      uint64                     `protobuf:"varint,12,opt,name=tombstone_time_tick,json=tombstoneTimeTick,proto3" json:"tombstone_time_tick,omitempty"`                  // The timetick this retained segment meta starts filtering replay.
}

func (x *SegmentAssignmentMeta) Reset() {
	*x = SegmentAssignmentMeta{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[100]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SegmentAssignmentMeta) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{100}
}
...
func (x *SegmentAssignmentMeta) GetPersistedStorage() *L1SegmentPersistedStorage {
	if x != nil {
		return x.PersistedStorage
	}
	return nil
}

func (x *SegmentAssignmentMeta) GetSealedAtDataVersion() *viewpb.DataVersion {
	if x != nil {
		return x.SealedAtDataVersion
	}
	return nil
}

func (x *SegmentAssignmentMeta) GetDataCheckpointTimeTick() uint64 {
	if x != nil {
		return x.DataCheckpointTimeTick
	}
	return 0
}

func (x *SegmentAssignmentMeta) GetTombstoneTimeTick() uint64 {
	if x != nil {
		return x.TombstoneTimeTick
	}
	return 0
...
type L1SegmentPersistedStorage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ManifestPath      string              `protobuf:"bytes,1,opt,name=manifest_path,json=manifestPath,proto3" json:"manifest_path,omitempty"`
	Binlogs           []*L1SegmentBinLogs `protobuf:"bytes,2,rep,name=binlogs,proto3" json:"binlogs,omitempty"`
	MergedStatsBinlog *datapb.FieldBinlog `protobuf:"bytes,3,opt,name=merged_stats_binlog,json=mergedStatsBinlog,proto3" json:"merged_stats_binlog,omitempty"`
}

func (x *L1SegmentPersistedStorage) Reset() {
	*x = L1SegmentPersistedStorage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[101]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *L1SegmentPersistedStorage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*L1SegmentPersistedStorage) ProtoMessage() {}

func (x *L1SegmentPersistedStorage) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[101]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use L1SegmentPersistedStorage.ProtoReflect.Descriptor instead.
func (*L1SegmentPersistedStorage) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{101}
}

func (x *L1SegmentPersistedStorage) GetManifestPath() string {
	if x != nil {
...
func (x *L1SegmentPersistedStorage) GetBinlogs() []*L1SegmentBinLogs {
	if x != nil {
		return x.Binlogs
	}
	return nil
...
func (x *L1SegmentPersistedStorage) GetMergedStatsBinlog() *datapb.FieldBinlog {
	if x != nil {
		return x.MergedStatsBinlog
	}
	return nil
}

type L1SegmentBinLogs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	FieldBinlog  []*datapb.FieldBinlog `protobuf:"bytes,1,rep,name=field_binlog,json=fieldBinlog,proto3" json:"field_binlog,omitempty"`
	StatsBinlog  []*datapb.FieldBinlog `protobuf:"bytes,2,rep,name=stats_binlog,json=statsBinlog,proto3" json:"stats_binlog,omitempty"`
	Bm25Binlog   []*datapb.FieldBinlog `protobuf:"bytes,3,rep,name=bm25_binlog,json=bm25Binlog,proto3" json:"bm25_binlog,omitempty"`
	FromTimeTick uint64                `protobuf:"varint,4,opt,name=from_time_tick,json=fromTimeTick,proto3" json:"from_time_tick,omitempty"`
	ToTimeTick   uint64                `protobuf:"varint,5,opt,name=to_time_tick,json=toTimeTick,proto3" json:"to_time_tick,omitempty"`
}

func (x *L1SegmentBinLogs) Reset() {
	*x = L1SegmentBinLogs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[102]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *L1SegmentBinLogs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*L1SegmentBinLogs) ProtoMessage() {}

func (x *L1SegmentBinLogs) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[102]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use L1SegmentBinLogs.ProtoReflect.Descriptor instead.
func (*L1SegmentBinLogs) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{102}
}

func (x *L1SegmentBinLogs) GetFieldBinlog() []*datapb.FieldBinlog {
	if x != nil {
		return x.FieldBinlog
	}
	return nil
}

func (x *L1SegmentBinLogs) GetStatsBinlog() []*datapb.FieldBinlog {
	if x != nil {
		return x.StatsBinlog
	}
	return nil
}

func (x *L1SegmentBinLogs) GetBm25Binlog() []*datapb.FieldBinlog {
	if x != nil {
		return x.Bm25Binlog
	}
	return nil
...
func (x *L1SegmentBinLogs) GetFromTimeTick() uint64 {
	if x != nil {
		return x.FromTimeTick
	}
	return 0
}

func (x *L1SegmentBinLogs) GetToTimeTick() uint64 {
	if x != nil {
		return x.ToTimeTick
	}
	return 0
...
func (x *SegmentAssignmentStat) Reset() {
	*x = SegmentAssignmentStat{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[103]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SegmentAssignmentStat) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{103}
}
...
type WALCheckpoint struct {
	...
	DataCheckpoint *WALConsumeCheckpoint `protobuf:"bytes,7,opt,name=data_checkpoint,json=dataCheckpoint,proto3" json:"data_checkpoint,omitempty"`
}

func (x *WALCheckpoint) Reset() {
	*x = WALCheckpoint{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[104]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WALCheckpoint) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{104}
}
...
func (x *WALCheckpoint) GetDataCheckpoint() *WALConsumeCheckpoint {
	if x != nil {
		return x.DataCheckpoint
	}
	return nil
}
...
func (x *WALConsumeCheckpoint) Reset() {
	*x = WALConsumeCheckpoint{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[105]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *WALConsumeCheckpoint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WALConsumeCheckpoint) ProtoMessage() {}

func (x *WALConsumeCheckpoint) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[105]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WALConsumeCheckpoint.ProtoReflect.Descriptor instead.
func (*WALConsumeCheckpoint) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{105}
}

func (x *WALConsumeCheckpoint) GetMessageId() *commonpb.MessageID {
	if x != nil {
		return x.MessageId
	}
	return nil
...
func (x *WALConsumeCheckpoint) GetTimeTick() uint64 {
	if x != nil {
		return x.TimeTick
	}
	return 0
...
func (x *AlterWALState) Reset() {
	*x = AlterWALState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[106]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AlterWALState) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{106}
}
...
func (x *ReplicateConfigurationMeta) Reset() {
	*x = ReplicateConfigurationMeta{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[107]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReplicateConfigurationMeta) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{107}
}
...
func (x *ReplicatePChannelMeta) Reset() {
	*x = ReplicatePChannelMeta{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_proto_msgTypes[108]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReplicatePChannelMeta) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{108}
}
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0a, 0x76, 0x69, 0x65, 0x77, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x83, 0x01, 0x0a, 0x0c,
	0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04,
	0x74, 0x65, 0x72, 0x6d, 0x12, 0x4b, 0x0a, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x6d,
	...
	0x65, 0x22, 0xb7, 0x01, 0x0a, 0x15, 0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x41, 0x73,
	0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x74,
	0x65, 0x72, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x12,
	0x3d, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e,
	...
	0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x4b,
	0x0a, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x50, 0x43, 0x68,
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4d, 0x6f, 0x64, 0x65, 0x52,
	0x0a, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0xde, 0x02, 0x0a, 0x0c,
	0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x3e, 0x0a, 0x07,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x3d, 0x0a, 0x04,
	0x6e, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6d, 0x69, 0x6c,
	...
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x3f, 0x0a, 0x05, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x6d, 0x69, 0x6c,
	0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x69, 0x6e, 0x67, 0x2e, 0x50, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x4d, 0x65, 0x74, 0x61,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x4b, 0x0a, 0x09,
	...
	,
	...
	0x63, 0x61, 0x6c, 0x22, 0x99, 0x02, 0x0a, 0x0d, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73,
	0x74, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x38, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	,
	...
	0x63, 0x6b, 0x65, 0x64, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x10,
	0x61, 0x63, 0x6b, 0x65, 0x64, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73,
	0x22, 0xc8, 0x01, 0x0a, 0x0f, 0x41, 0x63, 0x6b, 0x65, 0x64, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70,
	...
	0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x74, 0x69, 0x63, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x54, 0x69, 0x63, 0x6b, 0x22, 0x4c, 0x0a, 0x10, 0x42,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9d, 0x01, 0x0a, 0x13, 0x42, 0x72, 0x6f, 0x61, 0x64,
	0x63, 0x61, 0x73, 0x74, 0x41, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x25,
	0x0a, 0x0c, 0x62, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x04, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0b, 0x62, 0x72, 0x6f, 0x61, 0x64, 0x63,
	0x61, 0x73, 0x74, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x08, 0x76, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65,
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x08, 0x76, 0x63, 0x68,
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x3f, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x16, 0x0a, 0x14, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63,
	0x61, 0x73, 0x74, 0x41, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9d,
	0x01, 0x0a, 0x23, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61,
	0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x51, 0x0a, 0x0d, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	,
	...
	,
	...
	0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x9a, 0x01, 0x0a, 0x1c, 0x52, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x45, 0x72,
	0x72, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a, 0x08, 0x70, 0x63,
	...
	,
	...
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x46, 0x75, 0x6c, 0x6c, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x41, 0x73, 0x73, 0x69, 0x67,
	0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x57, 0x69, 0x74, 0x68, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x48, 0x00, 0x52, 0x0e, 0x66, 0x75, 0x6c, 0x6c, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65,
	0x6e, 0x74, 0x12, 0x4f, 0x0a, 0x05, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	,
	...
	0x12, 0x46, 0x0a, 0x08, 0x63, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01,
	...
	0x6e, 0x6e, 0x65, 0x6c, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x08,
	0x63, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x64, 0x0a, 0x17, 0x72, 0x65, 0x70, 0x6c,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x6d, 0x69, 0x6c, 0x76,
	...
	,
	...
	0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xc7, 0x02, 0x0a, 0x17, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x41, 0x73, 0x73, 0x69, 0x67,
	...
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x12, 0x56, 0x0a, 0x10, 0x73, 0x68, 0x61, 0x72, 0x64, 0x5f,
	...
	,
	...
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68,
	0x61, 0x72, 0x64, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0a, 0x73, 0x68, 0x61, 0x72, 0x64, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x72,
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x09, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x64, 0x22, 0xfb, 0x01, 0x0a, 0x0d, 0x44,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x60, 0x0a, 0x1c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2a, 0x0a, 0x28, 0x53, 0x74,
	...
	,
	...
	,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x46, 0x0a, 0x07, 0x6d, 0x65, 0x74,
	0x72, 0x69, 0x63, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x6d, 0x69, 0x6c,
	0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x69, 0x6e, 0x67, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64,
	0x65, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x52, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63,
	0x73, 0x22, 0x64, 0x0a, 0x20, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f,
	0x64, 0x65, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x7a, 0x65,
	...
	,
	...
	0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x75, 0x6e, 0x74, 0x69,
	0x6d, 0x65, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x7a, 0x65, 0x72, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x08, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x7a, 0x65, 0x72,
	0x42, 0x0c, 0x0a, 0x0a, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x85,
	0x01, 0x0a, 0x2b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65,
	0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52,
	0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33,
	...
	,
	...
	0x74, 0x6f, 0x2e, 0x76, 0x69, 0x65, 0x77, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x56, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x22, 0xde, 0x01, 0x0a, 0x18, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49,
	0x6e, 0x66, 0x6f, 0x4f, 0x66, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x23, 0x0a,
	...
	0x49, 0x64, 0x12, 0x4f, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2e,
	0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x4f, 0x66, 0x56,
	0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x12, 0x4c, 0x0a, 0x07, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x18, 0x03,
	...
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x4f, 0x66,
	0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x52, 0x07, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x73, 0x22, 0xd0, 0x01, 0x0a, 0x1a, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x4f, 0x66, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	...
	0x6d, 0x65, 0x5f, 0x74, 0x69, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x63,
	0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x54, 0x69, 0x63,
	0x6b, 0x12, 0x41, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x2b, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x56, 0x43, 0x68, 0x61, 0x6e, 0x6e,
	0x65, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x22, 0xaa, 0x01, 0x0a, 0x17, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x50, 0x61, 0x74, 0x68, 0x12, 0x42, 0x0a, 0x07, 0x62, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2e,
	0x4c, 0x31, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x69, 0x6e, 0x4c, 0x6f, 0x67, 0x73,
	0x52, 0x07, 0x62, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x73, 0x12, 0x4e, 0x0a, 0x13, 0x6d, 0x65, 0x72,
	0x67, 0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x5f, 0x62, 0x69, 0x6e, 0x6c, 0x6f, 0x67,
	...
	0x42, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x52, 0x11, 0x6d, 0x65, 0x72, 0x67, 0x65, 0x64, 0x53, 0x74,
	0x61, 0x74, 0x73, 0x42, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x22, 0xa1, 0x02, 0x0a, 0x10, 0x4c, 0x31,
	0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x69, 0x6e, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x41,
	0x0a, 0x0c, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x62, 0x69, 0x6e, 0x6c, 0x6f, 0x67, 0x18, 0x01,
	...
	,
	...
	,
	...
	0x12, 0x19, 0x0a, 0x08, 0x6d, 0x61, 0x78, 0x5f, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x52, 0x6f, 0x77, 0x73, 0x22, 0xed, 0x03, 0x0a, 0x0d,
	0x57, 0x41, 0x4c, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x3d, 0x0a,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x54, 0x69, 0x63, 0x6b, 0x22,
	0xb9, 0x02, 0x0a, 0x0d, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x57, 0x41, 0x4c, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x12, 0x44, 0x0a, 0x0f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x77, 0x61, 0x6c, 0x5f,
	...
	,
	...
	,
	...
	,
	...
	0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x0d, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x43, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x12, 0x5f, 0x0a, 0x16, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69,
	0x7a, 0x65, 0x64, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x04,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x54, 0x45, 0x5f, 0x44, 0x52, 0x4f, 0x50, 0x50, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xb3, 0x01, 0x0a,
	...
	,
	...
	,
	...
	0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6c,
	...
	0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x57, 0x41, 0x4c, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63,
	0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x35, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67,
	0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x57, 0x41, 0x4c, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x88, 0x02, 0x01, 0x12, 0x81, 0x01, 0x0a, 0x12,
	0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76,
	...
	,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x83, 0x01, 0x0a, 0x14,
	0x47, 0x65, 0x74, 0x53, 0x61, 0x6c, 0x76, 0x61, 0x67, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x12, 0x33, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72,
	...
	0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x34, 0x2e, 0x6d, 0x69, 0x6c, 0x76,
	0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69,
	0x6e, 0x67, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x61, 0x6c, 0x76, 0x61, 0x67, 0x65, 0x43, 0x68, 0x65,
	0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x12, 0x60, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65, 0x12, 0x26, 0x2e, 0x6d,
	0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x72, 0x65,
	...
	,
	...
	,
...
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 111)
var file_streaming_proto_goTypes = []interface{}{
	...
	(PartitionState)(0),                                 // 6: milvus.proto.streaming.PartitionState
	...
	(*ShardAssignmentInfo)(nil),                         // 38: milvus.proto.streaming.ShardAssignmentInfo
	(*PChannelShardAssignment)(nil),                     // 39: milvus.proto.streaming.PChannelShardAssignment
	(*ShardAssignmentEntry)(nil),                        // 40: milvus.proto.streaming.ShardAssignmentEntry
	(*DeliverPolicy)(nil),                               // 41: milvus.proto.streaming.DeliverPolicy
	(*DeliverFilter)(nil),                               // 42: milvus.proto.streaming.DeliverFilter
	(*DeliverFilterTimeTickGT)(nil),                     // 43: milvus.proto.streaming.DeliverFilterTimeTickGT
	(*DeliverFilterTimeTickGTE)(nil),                    // 44: milvus.proto.streaming.DeliverFilterTimeTickGTE
	(*DeliverFilterMessageType)(nil),                    // 45: milvus.proto.streaming.DeliverFilterMessageType
	(*StreamingError)(nil),                              // 46: milvus.proto.streaming.StreamingError
	(*GetReplicateCheckpointRequest)(nil),               // 47: milvus.proto.streaming.GetReplicateCheckpointRequest
	(*GetReplicateCheckpointResponse)(nil),              // 48: milvus.proto.streaming.GetReplicateCheckpointResponse
	(*GetSalvageCheckpointRequest)(nil),                 // 49: milvus.proto.streaming.GetSalvageCheckpointRequest
	(*GetSalvageCheckpointResponse)(nil),                // 50: milvus.proto.streaming.GetSalvageCheckpointResponse
	...
	(*CreateTransformStreamRequest)(nil),                // 74: milvus.proto.streaming.CreateTransformStreamRequest
	(*TransformRequest)(nil),                            // 75: milvus.proto.streaming.TransformRequest
	(*CreateTransformSubscriptionRequest)(nil),          // 76: milvus.proto.streaming.CreateTransformSubscriptionRequest
	(*CloseTransformSubscriptionRequest)(nil),           // 77: milvus.proto.streaming.CloseTransformSubscriptionRequest
	(*CloseTransformStreamRequest)(nil),                 // 78: milvus.proto.streaming.CloseTransformStreamRequest
	(*TransformResponse)(nil),                           // 79: milvus.proto.streaming.TransformResponse
	(*CreateTransformSubscriptionResponse)(nil),         // 80: milvus.proto.streaming.CreateTransformSubscriptionResponse
	(*CloseTransformSubscriptionResponse)(nil),          // 81: milvus.proto.streaming.CloseTransformSubscriptionResponse
	(*TransformSubscriptionSyncUp)(nil),                 // 82: milvus.proto.streaming.TransformSubscriptionSyncUp
	(*TransformSubscriptionError)(nil),                  // 83: milvus.proto.streaming.TransformSubscriptionError
	(*CloseTransformStreamResponse)(nil),                // 84: milvus.proto.streaming.CloseTransformStreamResponse
	(*TransformMessageBatch)(nil),                       // 85: milvus.proto.streaming.TransformMessageBatch
	(*TransformDeleteBlock)(nil),                        // 86: milvus.proto.streaming.TransformDeleteBlock
	(*TransformDeleteEntry)(nil),                        // 87: milvus.proto.streaming.TransformDeleteEntry
	(*TransformLogEntry)(nil),                           // 88: milvus.proto.streaming.TransformLogEntry
	(*TransformLogChunk)(nil),                           // 89: milvus.proto.streaming.TransformLogChunk
	(*VChannelTransformLogMeta)(nil),                    // 90: milvus.proto.streaming.VChannelTransformLogMeta
	(*StreamingNodeManagerAssignRequest)(nil),           // 91: milvus.proto.streaming.StreamingNodeManagerAssignRequest
	(*StreamingNodeManagerAssignResponse)(nil),          // 92: milvus.proto.streaming.StreamingNodeManagerAssignResponse
	(*StreamingNodeManagerRemoveRequest)(nil),           // 93: milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	(*StreamingNodeManagerRemoveResponse)(nil),          // 94: milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	(*StreamingNodeManagerCollectStatusRequest)(nil),    // 95: milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	(*StreamingNodeMetrics)(nil),                        // 96: milvus.proto.streaming.StreamingNodeMetrics
	(*StreamingNodeWALMetrics)(nil),                     // 97: milvus.proto.streaming.StreamingNodeWALMetrics
	(*StreamingNodeRWWALMetrics)(nil),                   // 98: milvus.proto.streaming.StreamingNodeRWWALMetrics
	(*StreamingNodeROWALMetrics)(nil),                   // 99: milvus.proto.streaming.StreamingNodeROWALMetrics
	(*StreamingNodeManagerCollectStatusResponse)(nil),   // 100: milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	(*StreamingNodeRuntimeAnalyzerInfo)(nil),            // 101: milvus.proto.streaming.StreamingNodeRuntimeAnalyzerInfo
	(*StreamingNodeRuntimeAnalyzerValidation)(nil),      // 102: milvus.proto.streaming.StreamingNodeRuntimeAnalyzerValidation
	(*StreamingNodeManagerValidateRuntimeRequest)(nil),  // 103: milvus.proto.streaming.StreamingNodeManagerValidateRuntimeRequest
	(*StreamingNodeManagerValidateRuntimeResponse)(nil), // 104: milvus.proto.streaming.StreamingNodeManagerValidateRuntimeResponse
	(*VChannelMeta)(nil),                                // 105: milvus.proto.streaming.VChannelMeta
	(*SegmentDataVersionSummary)(nil),                   // 106: milvus.proto.streaming.SegmentDataVersionSummary
	(*CollectionInfoOfVChannel)(nil),                    // 107: milvus.proto.streaming.CollectionInfoOfVChannel
	(*CollectionSchemaOfVChannel)(nil),                  // 108: milvus.proto.streaming.CollectionSchemaOfVChannel
	(*PartitionInfoOfVChannel)(nil),                     // 109: milvus.proto.streaming.PartitionInfoOfVChannel
	(*SegmentAssignmentMeta)(nil),                       // 110: milvus.proto.streaming.SegmentAssignmentMeta
	(*L1SegmentPersistedStorage)(nil),                   // 111: milvus.proto.streaming.L1SegmentPersistedStorage
	(*L1SegmentBinLogs)(nil),                            // 112: milvus.proto.streaming.L1SegmentBinLogs
	(*SegmentAssignmentStat)(nil),                       // 113: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                               // 114: milvus.proto.streaming.WALCheckpoint
	(*WALConsumeCheckpoint)(nil),                        // 115: milvus.proto.streaming.WALConsumeCheckpoint
	(*AlterWALState)(nil),                               // 116: milvus.proto.streaming.AlterWALState
	(*ReplicateConfigurationMeta)(nil),                  // 117: milvus.proto.streaming.ReplicateConfigurationMeta
	(*ReplicatePChannelMeta)(nil),                       // 118: milvus.proto.streaming.ReplicatePChannelMeta
	nil,                                                 // 119: milvus.proto.streaming.BroadcastResponse.ResultsEntry
	nil,                                                 // 120: milvus.proto.streaming.AlterWALState.ConfigsEntry
	(*messagespb.Message)(nil),                          // 121: milvus.proto.messages.Message
	(*commonpb.MessageID)(nil),                          // 122: milvus.proto.common.MessageID
	(*commonpb.ImmutableMessage)(nil),                   // 123: milvus.proto.common.ImmutableMessage
	...
	(messagespb.MessageType)(0),                         // 127: milvus.proto.messages.MessageType
	(*commonpb.ReplicateCheckpoint)(nil),                // 128: milvus.proto.common.ReplicateCheckpoint
	(*messagespb.TxnContext)(nil),                       // 129: milvus.proto.messages.TxnContext
	(*anypb.Any)(nil),                                   // 130: google.protobuf.Any
	(*schemapb.IDs)(nil),                                // 131: milvus.proto.schema.IDs
	(*commonpb.Status)(nil),                             // 132: milvus.proto.common.Status
	(*viewpb.DataVersion)(nil),                          // 133: milvus.proto.view.DataVersion
	(*schemapb.CollectionSchema)(nil),                   // 134: milvus.proto.schema.CollectionSchema
	(*datapb.FieldBinlog)(nil),                          // 135: milvus.proto.data.FieldBinlog
	(datapb.SegmentLevel)(0),                            // 136: milvus.proto.data.SegmentLevel
	(commonpb.WALName)(0),                               // 137: milvus.proto.common.WALName
	(*commonpb.MilvusCluster)(nil),                      // 138: milvus.proto.common.MilvusCluster
	(*milvuspb.GetComponentStatesRequest)(nil),          // 139: milvus.proto.milvus.GetComponentStatesRequest
...
var file_streaming_proto_depIdxs = []int32{
	...
	121, // 7: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	...
	122, // 11: milvus.proto.streaming.AckedCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	122, // 12: milvus.proto.streaming.AckedCheckpoint.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	121, // 13: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	119, // 14: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	123, // 15: milvus.proto.streaming.BroadcastAckRequest.message:type_name -> milvus.proto.common.ImmutableMessage
	124, // 16: milvus.proto.streaming.UpdateReplicateConfigurationRequest.configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	125, // 19: milvus.proto.streaming.UpdateWALBalancePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	46,  // 24: milvus.proto.streaming.ReportAssignmentErrorRequest.err:type_name -> milvus.proto.streaming.StreamingError
	...
	124, // 30: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	...
	38,  // 36: milvus.proto.streaming.StreamingNodeAssignment.shard_assignment:type_name -> milvus.proto.streaming.ShardAssignmentInfo
	10,  // 37: milvus.proto.streaming.StreamingNodeAssignment.secondary_channels:type_name -> milvus.proto.streaming.PChannelInfo
	39,  // 38: milvus.proto.streaming.ShardAssignmentInfo.pchannel_assignments:type_name -> milvus.proto.streaming.PChannelShardAssignment
	40,  // 39: milvus.proto.streaming.PChannelShardAssignment.entries:type_name -> milvus.proto.streaming.ShardAssignmentEntry
	126, // 40: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	126, // 41: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	122, // 42: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.common.MessageID
	122, // 43: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.common.MessageID
	43,  // 44: milvus.proto.streaming.DeliverFilter.time_tick_gt:type_name -> milvus.proto.streaming.DeliverFilterTimeTickGT
	44,  // 45: milvus.proto.streaming.DeliverFilter.time_tick_gte:type_name -> milvus.proto.streaming.DeliverFilterTimeTickGTE
	45,  // 46: milvus.proto.streaming.DeliverFilter.message_type:type_name -> milvus.proto.streaming.DeliverFilterMessageType
	127, // 47: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	3,   // 48: milvus.proto.streaming.StreamingError.code:type_name -> milvus.proto.streaming.StreamingCode
	10,  // 49: milvus.proto.streaming.GetReplicateCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	128, // 50: milvus.proto.streaming.GetReplicateCheckpointResponse.checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	10,  // 51: milvus.proto.streaming.GetSalvageCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	128, // 52: milvus.proto.streaming.GetSalvageCheckpointResponse.checkpoints:type_name -> milvus.proto.common.ReplicateCheckpoint
	53,  // 53: milvus.proto.streaming.ProduceRequest.produce:type_name -> milvus.proto.streaming.ProduceMessageRequest
	54,  // 54: milvus.proto.streaming.ProduceRequest.close:type_name -> milvus.proto.streaming.CloseProducerRequest
	10,  // 55: milvus.proto.streaming.CreateProducerRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	121, // 56: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	56,  // 57: milvus.proto.streaming.ProduceResponse.create:type_name -> milvus.proto.streaming.CreateProducerResponse
	57,  // 58: milvus.proto.streaming.ProduceResponse.produce:type_name -> milvus.proto.streaming.ProduceMessageResponse
	60,  // 59: milvus.proto.streaming.ProduceResponse.close:type_name -> milvus.proto.streaming.CloseProducerResponse
	58,  // 60: milvus.proto.streaming.ProduceResponse.rate_limit:type_name -> milvus.proto.streaming.ProduceRateLimitResponse
	59,  // 61: milvus.proto.streaming.ProduceMessageResponse.result:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	46,  // 62: milvus.proto.streaming.ProduceMessageResponse.error:type_name -> milvus.proto.streaming.StreamingError
	4,   // 63: milvus.proto.streaming.ProduceRateLimitResponse.state:type_name -> milvus.proto.streaming.WALRateLimitState
	122, // 64: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.common.MessageID
	129, // 65: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	130, // 66: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	122, // 67: milvus.proto.streaming.ProduceMessageResponseResult.last_confirmed_id:type_name -> milvus.proto.common.MessageID
	65,  // 68: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumer:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	64,  // 69: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumers:type_name -> milvus.proto.streaming.CreateVChannelConsumersRequest
	68,  // 70: milvus.proto.streaming.ConsumeRequest.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerRequest
	62,  // 71: milvus.proto.streaming.ConsumeRequest.close:type_name -> milvus.proto.streaming.CloseConsumerRequest
	10,  // 72: milvus.proto.streaming.CreateConsumerRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	65,  // 73: milvus.proto.streaming.CreateVChannelConsumersRequest.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	41,  // 74: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_policy:type_name -> milvus.proto.streaming.DeliverPolicy
	42,  // 75: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_filters:type_name -> milvus.proto.streaming.DeliverFilter
	67,  // 76: milvus.proto.streaming.CreateVChannelConsumersResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	46,  // 77: milvus.proto.streaming.CreateVChannelConsumerResponse.error:type_name -> milvus.proto.streaming.StreamingError
	71,  // 78: milvus.proto.streaming.ConsumeResponse.create:type_name -> milvus.proto.streaming.CreateConsumerResponse
	72,  // 79: milvus.proto.streaming.ConsumeResponse.consume:type_name -> milvus.proto.streaming.ConsumeMessageReponse
	67,  // 80: milvus.proto.streaming.ConsumeResponse.create_vchannel:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	66,  // 81: milvus.proto.streaming.ConsumeResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumersResponse
	69,  // 82: milvus.proto.streaming.ConsumeResponse.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerResponse
	73,  // 83: milvus.proto.streaming.ConsumeResponse.close:type_name -> milvus.proto.streaming.CloseConsumerResponse
	123, // 84: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.common.ImmutableMessage
	10,  // 85: milvus.proto.streaming.CreateTransformStreamRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	76,  // 86: milvus.proto.streaming.TransformRequest.create:type_name -> milvus.proto.streaming.CreateTransformSubscriptionRequest
	77,  // 87: milvus.proto.streaming.TransformRequest.close_subscription:type_name -> milvus.proto.streaming.CloseTransformSubscriptionRequest
	78,  // 88: milvus.proto.streaming.TransformRequest.close_stream:type_name -> milvus.proto.streaming.CloseTransformStreamRequest
	80,  // 89: milvus.proto.streaming.TransformResponse.create:type_name -> milvus.proto.streaming.CreateTransformSubscriptionResponse
	85,  // 90: milvus.proto.streaming.TransformResponse.message_batch:type_name -> milvus.proto.streaming.TransformMessageBatch
	82,  // 91: milvus.proto.streaming.TransformResponse.sync_up:type_name -> milvus.proto.streaming.TransformSubscriptionSyncUp
	83,  // 92: milvus.proto.streaming.TransformResponse.subscription_error:type_name -> milvus.proto.streaming.TransformSubscriptionError
	81,  // 93: milvus.proto.streaming.TransformResponse.close_subscription:type_name -> milvus.proto.streaming.CloseTransformSubscriptionResponse
	84,  // 94: milvus.proto.streaming.TransformResponse.close_stream:type_name -> milvus.proto.streaming.CloseTransformStreamResponse
	46,  // 95: milvus.proto.streaming.TransformSubscriptionError.error:type_name -> milvus.proto.streaming.StreamingError
	88,  // 96: milvus.proto.streaming.TransformMessageBatch.entries:type_name -> milvus.proto.streaming.TransformLogEntry
	131, // 97: milvus.proto.streaming.TransformDeleteBlock.primary_keys:type_name -> milvus.proto.schema.IDs
	86,  // 98: milvus.proto.streaming.TransformDeleteEntry.blocks:type_name -> milvus.proto.streaming.TransformDeleteBlock
	87,  // 99: milvus.proto.streaming.TransformLogEntry.delete:type_name -> milvus.proto.streaming.TransformDeleteEntry
	88,  // 100: milvus.proto.streaming.TransformLogChunk.entries:type_name -> milvus.proto.streaming.TransformLogEntry
	10,  // 101: milvus.proto.streaming.StreamingNodeManagerAssignRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	10,  // 102: milvus.proto.streaming.StreamingNodeManagerRemoveRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	97,  // 103: milvus.proto.streaming.StreamingNodeMetrics.wals:type_name -> milvus.proto.streaming.StreamingNodeWALMetrics
	10,  // 104: milvus.proto.streaming.StreamingNodeWALMetrics.info:type_name -> milvus.proto.streaming.PChannelInfo
	98,  // 105: milvus.proto.streaming.StreamingNodeWALMetrics.rw:type_name -> milvus.proto.streaming.StreamingNodeRWWALMetrics
	99,  // 106: milvus.proto.streaming.StreamingNodeWALMetrics.ro:type_name -> milvus.proto.streaming.StreamingNodeROWALMetrics
	96,  // 107: milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse.metrics:type_name -> milvus.proto.streaming.StreamingNodeMetrics
	101, // 108: milvus.proto.streaming.StreamingNodeRuntimeAnalyzerValidation.analyzer_infos:type_name -> milvus.proto.streaming.StreamingNodeRuntimeAnalyzerInfo
	102, // 109: milvus.proto.streaming.StreamingNodeManagerValidateRuntimeRequest.analyzer:type_name -> milvus.proto.streaming.StreamingNodeRuntimeAnalyzerValidation
	132, // 110: milvus.proto.streaming.StreamingNodeManagerValidateRuntimeResponse.status:type_name -> milvus.proto.common.Status
	5,   // 111: milvus.proto.streaming.VChannelMeta.state:type_name -> milvus.proto.streaming.VChannelState
	107, // 112: milvus.proto.streaming.VChannelMeta.collection_info:type_name -> milvus.proto.streaming.CollectionInfoOfVChannel
	133, // 113: milvus.proto.streaming.SegmentDataVersionSummary.data_version:type_name -> milvus.proto.view.DataVersion
	109, // 114: milvus.proto.streaming.CollectionInfoOfVChannel.partitions:type_name -> milvus.proto.streaming.PartitionInfoOfVChannel
	108, // 115: milvus.proto.streaming.CollectionInfoOfVChannel.schemas:type_name -> milvus.proto.streaming.CollectionSchemaOfVChannel
	134, // 116: milvus.proto.streaming.CollectionSchemaOfVChannel.schema:type_name -> milvus.proto.schema.CollectionSchema
	7,   // 117: milvus.proto.streaming.CollectionSchemaOfVChannel.state:type_name -> milvus.proto.streaming.VChannelSchemaState
	6,   // 118: milvus.proto.streaming.PartitionInfoOfVChannel.state:type_name -> milvus.proto.streaming.PartitionState
	8,   // 119: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	113, // 120: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	111, // 121: milvus.proto.streaming.SegmentAssignmentMeta.persisted_storage:type_name -> milvus.proto.streaming.L1SegmentPersistedStorage
	133, // 122: milvus.proto.streaming.SegmentAssignmentMeta.sealed_at_data_version:type_name -> milvus.proto.view.DataVersion
	112, // 123: milvus.proto.streaming.L1SegmentPersistedStorage.binlogs:type_name -> milvus.proto.streaming.L1SegmentBinLogs
	135, // 124: milvus.proto.streaming.L1SegmentPersistedStorage.merged_stats_binlog:type_name -> milvus.proto.data.FieldBinlog
	135, // 125: milvus.proto.streaming.L1SegmentBinLogs.field_binlog:type_name -> milvus.proto.data.FieldBinlog
	135, // 126: milvus.proto.streaming.L1SegmentBinLogs.stats_binlog:type_name -> milvus.proto.data.FieldBinlog
	135, // 127: milvus.proto.streaming.L1SegmentBinLogs.bm25_binlog:type_name -> milvus.proto.data.FieldBinlog
	136, // 128: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	122, // 129: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	124, // 130: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	128, // 131: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	116, // 132: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	115, // 133: milvus.proto.streaming.WALCheckpoint.data_checkpoint:type_name -> milvus.proto.streaming.WALConsumeCheckpoint
	122, // 134: milvus.proto.streaming.WALConsumeCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	137, // 135: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	120, // 136: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	9,   // 137: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	124, // 138: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	17,  // 139: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	138, // 140: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	128, // 141: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	59,  // 142: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	139, // 143: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	19,  // 144: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	21,  // 145: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	23,  // 146: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	25,  // 147: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	29,  // 148: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	47,  // 149: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	49,  // 150: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:input_type -> milvus.proto.streaming.GetSalvageCheckpointRequest
	51,  // 151: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	61,  // 152: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	75,  // 153: milvus.proto.streaming.StreamingNodeHandlerService.SubscribeTransform:input_type -> milvus.proto.streaming.TransformRequest
	91,  // 154: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	93,  // 155: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	95,  // 156: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	103, // 157: milvus.proto.streaming.StreamingNodeManagerService.ValidateRuntime:input_type -> milvus.proto.streaming.StreamingNodeManagerValidateRuntimeRequest
	140, // 158: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	20,  // 159: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	22,  // 160: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	24,  // 161: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	28,  // 162: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	32,  // 163: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	48,  // 164: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	50,  // 165: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:output_type -> milvus.proto.streaming.GetSalvageCheckpointResponse
	55,  // 166: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	70,  // 167: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	79,  // 168: milvus.proto.streaming.StreamingNodeHandlerService.SubscribeTransform:output_type -> milvus.proto.streaming.TransformResponse
	92,  // 169: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	94,  // 170: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	100, // 171: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	104, // 172: milvus.proto.streaming.StreamingNodeManagerService.ValidateRuntime:output_type -> milvus.proto.streaming.StreamingNodeManagerValidateRuntimeResponse
	158, // [158:173] is the sub-list for method output_type
	143, // [143:158] is the sub-list for method input_type
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShardAssignmentInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PChannelShardAssignment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShardAssignmentEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[64].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateTransformStreamRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[66].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateTransformSubscriptionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[67].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CloseTransformSubscriptionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CloseTransformStreamRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[70].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateTransformSubscriptionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[71].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CloseTransformSubscriptionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[72].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformSubscriptionSyncUp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[73].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformSubscriptionError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[74].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CloseTransformStreamResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[75].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformMessageBatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[76].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformDeleteBlock); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[77].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformDeleteEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[78].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformLogEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[79].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformLogChunk); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[80].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VChannelTransformLogMeta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[85].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[86].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[87].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[88].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[89].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[90].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[91].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingNodeRuntimeAnalyzerInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[92].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingNodeRuntimeAnalyzerValidation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[93].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingNodeManagerValidateRuntimeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[94].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingNodeManagerValidateRuntimeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[95].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[96].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SegmentDataVersionSummary); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[97].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[98].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[99].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[100].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[101].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*L1SegmentPersistedStorage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[102].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*L1SegmentBinLogs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[103].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[104].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[105].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WALConsumeCheckpoint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[106].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[107].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[108].Exporter = func(v interface{}, i int) interface{} {
	...
	file_streaming_proto_msgTypes[65].OneofWrappers = []interface{}{
		(*TransformRequest_Create)(nil),
		(*TransformRequest_CloseSubscription)(nil),
		(*TransformRequest_CloseStream)(nil),
	}
	file_streaming_proto_msgTypes[69].OneofWrappers = []interface{}{
		(*TransformResponse_Create)(nil),
		(*TransformResponse_MessageBatch)(nil),
		(*TransformResponse_SyncUp)(nil),
		(*TransformResponse_SubscriptionError)(nil),
		(*TransformResponse_CloseSubscription)(nil),
		(*TransformResponse_CloseStream)(nil),
	}
	file_streaming_proto_msgTypes[78].OneofWrappers = []interface{}{
		(*TransformLogEntry_Delete)(nil),
	}
	file_streaming_proto_msgTypes[87].OneofWrappers = []interface{}{
		(*StreamingNodeWALMetrics_Rw)(nil),
		(*StreamingNodeWALMetrics_Ro)(nil),
	}
	file_streaming_proto_msgTypes[93].OneofWrappers = []interface{}{
		(*StreamingNodeManagerValidateRuntimeRequest_Analyzer)(nil),
	}
	type x struct{}
