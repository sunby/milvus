...
const (
	...
	QueryCoord_WaitCollectionReady_FullMethodName           = "/milvus.proto.query.QueryCoord/WaitCollectionReady"
)
...
type QueryCoordClient interface {
	...
	// Waits for all expected shards to become queryable. Does not initiate load.
	WaitCollectionReady(ctx context.Context, in *WaitCollectionReadyRequest, opts ...grpc.CallOption) (*commonpb.Status, error)
}
...
func (c *queryCoordClient) WaitCollectionReady(ctx context.Context, in *WaitCollectionReadyRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	out := new(commonpb.Status)
	err := c.cc.Invoke(ctx, QueryCoord_WaitCollectionReady_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryCoordServer interface {
	...
	// Waits for all expected shards to become queryable. Does not initiate load.
	WaitCollectionReady(context.Context, *WaitCollectionReadyRequest) (*commonpb.Status, error)
}
...
func (UnimplementedQueryCoordServer) WaitCollectionReady(context.Context, *WaitCollectionReadyRequest) (*commonpb.Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WaitCollectionReady not implemented")
}
...
func _QueryCoord_WaitCollectionReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitCollectionReadyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryCoordServer).WaitCollectionReady(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QueryCoord_WaitCollectionReady_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryCoordServer).WaitCollectionReady(ctx, req.(*WaitCollectionReadyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var QueryCoord_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WaitCollectionReady",
			Handler:    _QueryCoord_WaitCollectionReady_Handler,
		},
	},
