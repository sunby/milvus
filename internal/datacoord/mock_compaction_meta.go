...
func (_m *MockCompactionMeta) UpdateSegmentsInfo(ctx context.Context, mutations map[int64][]MutateFunc, newSegments ...*datapb.SegmentInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, map[int64][]MutateFunc, ...*datapb.SegmentInfo) error); ok {
...
func (_c *MockCompactionMeta_UpdateSegmentsInfo_Call) Run(run func(ctx context.Context, mutations map[int64][]MutateFunc, newSegments ...*datapb.SegmentInfo)) *MockCompactionMeta_UpdateSegmentsInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(map[int64][]MutateFunc), variadicArgs...)
	})
	return _c
}
...
func (_c *MockCompactionMeta_UpdateSegmentsInfo_Call) RunAndReturn(run func(context.Context, map[int64][]MutateFunc, ...*datapb.SegmentInfo) error) *MockCompactionMeta_UpdateSegmentsInfo_Call {
	_c.Call.Return(run)
	return _c
}
