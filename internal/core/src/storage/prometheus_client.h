...
DECLARE_PROMETHEUS_HISTOGRAM_FAMILY(internal_load_field_time_index);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_field_time_index_download);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_field_time_index_assemble);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_field_time_index_knowhere);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_field_time_index_fill);

DECLARE_PROMETHEUS_HISTOGRAM_FAMILY(internal_load_field_time_rawdata);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_field_time_rawdata_download);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_field_time_rawdata_process);

DECLARE_PROMETHEUS_HISTOGRAM_FAMILY(
    internal_load_file_download_deser_time_rawdata);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_file_download_time_rawdata);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_file_deser_time_rawdata);
DECLARE_PROMETHEUS_HISTOGRAM_FAMILY(
    internal_load_file_download_deser_time_index);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_file_download_time_index);
DECLARE_PROMETHEUS_HISTOGRAM(internal_load_file_deser_time_index);
