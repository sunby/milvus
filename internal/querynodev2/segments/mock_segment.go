...
// JsonIndexes provides a mock function with given fields:
func (_m *MockSegment) JsonIndexes() []*IndexedFieldInfo {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for JsonIndexes")
	}
...
// MockSegment_JsonIndexes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'JsonIndexes'
type MockSegment_JsonIndexes_Call struct {
	*mock.Call
}

// JsonIndexes is a helper method to define mock.On call
func (_e *MockSegment_Expecter) JsonIndexes() *MockSegment_JsonIndexes_Call {
	return &MockSegment_JsonIndexes_Call{Call: _e.mock.On("JsonIndexes")}
}

func (_c *MockSegment_JsonIndexes_Call) Run(run func()) *MockSegment_JsonIndexes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSegment_JsonIndexes_Call) Return(_a0 []*IndexedFieldInfo) *MockSegment_JsonIndexes_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSegment_JsonIndexes_Call) RunAndReturn(run func() []*IndexedFieldInfo) *MockSegment_JsonIndexes_Call {
	_c.Call.Return(run)
	return _c
}
