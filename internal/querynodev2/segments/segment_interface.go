...
type Segment interface {
	...
	Prewarm(ctx context.Context, fieldIDs []int64) error
...
type FlushConfig struct {
	...
	// PKStatsBlob is generated by Go and committed by C++ in the same manifest
	// transaction as the flushed data files.
	PKStatsFieldID int64
	PKStatsLogID   int64
	PKStatsBlob    []byte
	// MergedPKStatsBlob is a compound BF stats blob generated by Go for a final
	// growing-source flush. C++ writes it into the same manifest transaction as
	// the flushed data.
