...
// RemoveBroadcastTasks provides a mock function with given fields: ctx, broadcastIDs
func (_m *MockStreamingCoordCataLog) RemoveBroadcastTasks(ctx context.Context, broadcastIDs []uint64) error {
	ret := _m.Called(ctx, broadcastIDs)

	if len(ret) == 0 {
		panic("no return value specified for RemoveBroadcastTasks")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []uint64) error); ok {
		r0 = rf(ctx, broadcastIDs)
	} else {
		r0 = ret.Error(0)
	}
...
// MockStreamingCoordCataLog_RemoveBroadcastTasks_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveBroadcastTasks'
type MockStreamingCoordCataLog_RemoveBroadcastTasks_Call struct {
	*mock.Call
}

// RemoveBroadcastTasks is a helper method to define mock.On call
//   - ctx context.Context
//   - broadcastIDs []uint64
func (_e *MockStreamingCoordCataLog_Expecter) RemoveBroadcastTasks(ctx interface{}, broadcastIDs interface{}) *MockStreamingCoordCataLog_RemoveBroadcastTasks_Call {
	return &MockStreamingCoordCataLog_RemoveBroadcastTasks_Call{Call: _e.mock.On("RemoveBroadcastTasks", ctx, broadcastIDs)}
}

func (_c *MockStreamingCoordCataLog_RemoveBroadcastTasks_Call) Run(run func(ctx context.Context, broadcastIDs []uint64)) *MockStreamingCoordCataLog_RemoveBroadcastTasks_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockStreamingCoordCataLog_RemoveBroadcastTasks_Call) Return(_a0 error) *MockStreamingCoordCataLog_RemoveBroadcastTasks_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStreamingCoordCataLog_RemoveBroadcastTasks_Call) RunAndReturn(run func(context.Context, []uint64) error) *MockStreamingCoordCataLog_RemoveBroadcastTasks_Call {
	_c.Call.Return(run)
	return _c
}
