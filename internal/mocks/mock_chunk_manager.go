...
func (_m *ChunkManager) MultiRemoveWithPrefix(ctx context.Context, prefixes []string) []storage.RemovePrefixResult {
...
// ChunkManager_MultiRemoveWithPrefix_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MultiRemoveWithPrefix'
type ChunkManager_MultiRemoveWithPrefix_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - prefixes []string
func (_e *ChunkManager_Expecter) MultiRemoveWithPrefix(ctx interface{}, prefixes interface{}) *ChunkManager_MultiRemoveWithPrefix_Call {
	return &ChunkManager_MultiRemoveWithPrefix_Call{Call: _e.mock.On("MultiRemoveWithPrefix", ctx, prefixes)}
}

func (_c *ChunkManager_MultiRemoveWithPrefix_Call) Run(run func(ctx context.Context, prefixes []string)) *ChunkManager_MultiRemoveWithPrefix_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string))
	})
	return _c
...
func (_c *ChunkManager_MultiRemoveWithPrefix_Call) Return(_a0 []storage.RemovePrefixResult) *ChunkManager_MultiRemoveWithPrefix_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ChunkManager_MultiRemoveWithPrefix_Call) RunAndReturn(run func(context.Context, []string) []storage.RemovePrefixResult) *ChunkManager_MultiRemoveWithPrefix_Call {
	_c.Call.Return(run)
	return _c
}
