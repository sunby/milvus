...
func (_m *MockQueryNodeClient) ClearReadTaskQueue(ctx context.Context, in *internalpb.ClearReadTaskQueueRequest, opts ...grpc.CallOption) (*internalpb.ClearReadTaskQueueResponse, error) {
...
// MockQueryNodeClient_ClearReadTaskQueue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ClearReadTaskQueue'
type MockQueryNodeClient_ClearReadTaskQueue_Call struct {
	*mock.Call
}
...
func (_e *MockQueryNodeClient_Expecter) ClearReadTaskQueue(ctx interface{}, in interface{}, opts ...interface{}) *MockQueryNodeClient_ClearReadTaskQueue_Call {
	return &MockQueryNodeClient_ClearReadTaskQueue_Call{Call: _e.mock.On("ClearReadTaskQueue",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockQueryNodeClient_ClearReadTaskQueue_Call) Run(run func(ctx context.Context, in *internalpb.ClearReadTaskQueueRequest, opts ...grpc.CallOption)) *MockQueryNodeClient_ClearReadTaskQueue_Call {
...
func (_c *MockQueryNodeClient_ClearReadTaskQueue_Call) Return(_a0 *internalpb.ClearReadTaskQueueResponse, _a1 error) *MockQueryNodeClient_ClearReadTaskQueue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNodeClient_ClearReadTaskQueue_Call) RunAndReturn(run func(context.Context, *internalpb.ClearReadTaskQueueRequest, ...grpc.CallOption) (*internalpb.ClearReadTaskQueueResponse, error)) *MockQueryNodeClient_ClearReadTaskQueue_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockQueryNodeClient) Prewarm(ctx context.Context, in *querypb.PrewarmRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockQueryNodeClient_Prewarm_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Prewarm'
type MockQueryNodeClient_Prewarm_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockQueryNodeClient_Expecter) Prewarm(ctx interface{}, in interface{}, opts ...interface{}) *MockQueryNodeClient_Prewarm_Call {
	return &MockQueryNodeClient_Prewarm_Call{Call: _e.mock.On("Prewarm",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockQueryNodeClient_Prewarm_Call) Run(run func(ctx context.Context, in *querypb.PrewarmRequest, opts ...grpc.CallOption)) *MockQueryNodeClient_Prewarm_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockQueryNodeClient_Prewarm_Call) Return(_a0 *commonpb.Status, _a1 error) *MockQueryNodeClient_Prewarm_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryNodeClient_Prewarm_Call) RunAndReturn(run func(context.Context, *querypb.PrewarmRequest, ...grpc.CallOption) (*commonpb.Status, error)) *MockQueryNodeClient_Prewarm_Call {
	_c.Call.Return(run)
	return _c
}
