...
// MultiRemoveWithPrefix provides a mock function with given fields: ctx, prefixes
func (_m *MockChunkManager) MultiRemoveWithPrefix(ctx context.Context, prefixes []string) []storage.RemovePrefixResult {
	ret := _m.Called(ctx, prefixes)

	if len(ret) == 0 {
		panic("no return value specified for MultiRemoveWithPrefix")
	}

	var r0 []storage.RemovePrefixResult
	if rf, ok := ret.Get(0).(func(context.Context, []string) []storage.RemovePrefixResult); ok {
		r0 = rf(ctx, prefixes)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]storage.RemovePrefixResult)
		}
	}
...
// MockChunkManager_MultiRemoveWithPrefix_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MultiRemoveWithPrefix'
type MockChunkManager_MultiRemoveWithPrefix_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - prefixes []string
func (_e *MockChunkManager_Expecter) MultiRemoveWithPrefix(ctx interface{}, prefixes interface{}) *MockChunkManager_MultiRemoveWithPrefix_Call {
	return &MockChunkManager_MultiRemoveWithPrefix_Call{Call: _e.mock.On("MultiRemoveWithPrefix", ctx, prefixes)}
}

func (_c *MockChunkManager_MultiRemoveWithPrefix_Call) Run(run func(ctx context.Context, prefixes []string)) *MockChunkManager_MultiRemoveWithPrefix_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string))
	})
	return _c
...
func (_c *MockChunkManager_MultiRemoveWithPrefix_Call) Return(_a0 []storage.RemovePrefixResult) *MockChunkManager_MultiRemoveWithPrefix_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockChunkManager_MultiRemoveWithPrefix_Call) RunAndReturn(run func(context.Context, []string) []storage.RemovePrefixResult) *MockChunkManager_MultiRemoveWithPrefix_Call {
	_c.Call.Return(run)
	return _c
}
