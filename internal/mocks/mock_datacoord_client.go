...
func (_m *MockDataCoordClient) ExportSnapshot(ctx context.Context, in *datapb.ExportSnapshotRequest, opts ...grpc.CallOption) (*datapb.ExportSnapshotResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockDataCoordClient_ExportSnapshot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ExportSnapshot'
type MockDataCoordClient_ExportSnapshot_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) ExportSnapshot(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_ExportSnapshot_Call {
	return &MockDataCoordClient_ExportSnapshot_Call{Call: _e.mock.On("ExportSnapshot",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockDataCoordClient_ExportSnapshot_Call) Run(run func(ctx context.Context, in *datapb.ExportSnapshotRequest, opts ...grpc.CallOption)) *MockDataCoordClient_ExportSnapshot_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockDataCoordClient_ExportSnapshot_Call) Return(_a0 *datapb.ExportSnapshotResponse, _a1 error) *MockDataCoordClient_ExportSnapshot_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoordClient_ExportSnapshot_Call) RunAndReturn(run func(context.Context, *datapb.ExportSnapshotRequest, ...grpc.CallOption) (*datapb.ExportSnapshotResponse, error)) *MockDataCoordClient_ExportSnapshot_Call {
	_c.Call.Return(run)
	return _c
}
