...
// Prewarm provides a mock function with given fields: ctx, nodeID, req
func (_m *MockCluster) Prewarm(ctx context.Context, nodeID int64, req *querypb.PrewarmRequest) (*commonpb.Status, error) {
	ret := _m.Called(ctx, nodeID, req)
	...
	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, *querypb.PrewarmRequest) (*commonpb.Status, error)); ok {
		return rf(ctx, nodeID, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, *querypb.PrewarmRequest) *commonpb.Status); ok {
		r0 = rf(ctx, nodeID, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, int64, *querypb.PrewarmRequest) error); ok {
		r1 = rf(ctx, nodeID, req)
	} else {
		r1 = ret.Error(1)
	}
...
// MockCluster_Prewarm_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Prewarm'
type MockCluster_Prewarm_Call struct {
	*mock.Call
}
...
func (_e *MockCluster_Expecter) Prewarm(ctx interface{}, nodeID interface{}, req interface{}) *MockCluster_Prewarm_Call {
	return &MockCluster_Prewarm_Call{Call: _e.mock.On("Prewarm", ctx, nodeID, req)}
}

func (_c *MockCluster_Prewarm_Call) Run(run func(ctx context.Context, nodeID int64, req *querypb.PrewarmRequest)) *MockCluster_Prewarm_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(*querypb.PrewarmRequest))
	})
	return _c
}

func (_c *MockCluster_Prewarm_Call) Return(_a0 *commonpb.Status, _a1 error) *MockCluster_Prewarm_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCluster_Prewarm_Call) RunAndReturn(run func(context.Context, int64, *querypb.PrewarmRequest) (*commonpb.Status, error)) *MockCluster_Prewarm_Call {
	_c.Call.Return(run)
	return _c
}
